  ...
  describe('should support close()', function() {
    var samplers = (0, _combinations2.default)({
      ...
      sampler: [
        ...
        new _probabilistic_sampler2.default(0.5),
        new _ratelimiting_sampler2.default(2),
        new _guaranteed_throughput_sampler2.default(2, 0.5),
        new _per_operation_sampler2.default(
          {
        ...
        new _remote_sampler2.default('some-service-name'),
      ],
    });
    ...
    var samplers = [
      {
        ...
        type: constants.SAMPLER_TYPE_CONST,
        param: true,
        decision: true,
      },
      {
        sampler: new _const_sampler2.default(false),
        type: constants.SAMPLER_TYPE_CONST,
        param: false,
        decision: false,
      },
      ...
      {
        sampler: new _remote_sampler2.default('some-caller-name', {
          sampler: new _probabilistic_sampler2.default(1.0),
        }),
        type: constants.SAMPLER_TYPE_PROBABILISTIC,
        param: 1.0,
